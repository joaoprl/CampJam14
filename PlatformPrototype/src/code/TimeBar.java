...
public class TimeBar {
	...
	public void draw(Graphics2D g) {
		...
		timeBar.draw(g, position.x + (int) (complete * timeBar.SPRITE_WIDTH) + (backgroundBar.SPRITE_WIDTH - timeBar.SPRITE_WIDTH) / 2, position.y
						+ (backgroundBar.SPRITE_HEIGHT - timeBar.SPRITE_HEIGHT) / 2, 1f - complete, 1f);
	}
